YUI().use(
	...
	function (A) {
		var Lang = A.Lang,
			...
			TPL_TRIGGER = '<a href="javascript:;" data-chatlauncher="{chatLauncher}">{content}</a>';
		...
		var ChatLauncher = A.Component.create(
			{
				...
				prototype: {
					...
					_getChatLink: function(userData, type, topic) {
						var instance = this,
							href = instance._getSkypeURI(userData, type, topic);
					...
					_getSkypeURI: function(userData, type, topic) {
						var instance = this,
							href = ['skype:'],
							conferenceTopic;
					...
					_syncPopover: function(event) {
						...
						var triggerId = currentTarget.guid();

						if (triggerId != instance._activeId) {
							popover.set('align.node', currentTarget);

							var content = instance._getPopoverBodyContent(currentTarget, ['call', 'chat']);
