YUI().use(
	...
	function (A) {
		var Lang = A.Lang,
			...
			TPL_EMAIL_ICON = '<svg height="20" style="fill:#00afff; vertical-align: bottom;" width="20">' +
				'<use xlink:href="#emailIconTemplate">' +
			'</svg>',

			TPL_MOBILE_ICON = '<svg height="20" style="fill:#00afff; vertical-align: bottom;" width="20">' +
				...
				prototype: {
					...
					_emailGroupLabelFn: function() {
						var instance = this,
							...
							emailIconTemplate = instance._emailIconTemplate,
							label;

						if (!emailIconTemplate) {
							instance._getBodyNode().append(SVG_EMAIL_ICON);

							instance._emailIconTemplate = true;
						}
					...
					_renderSkypeIconTemplate: function() {
						...
						if (!skypeIconTemplate) {
							instance._getBodyNode().append(SVG_SKYPE_ICON);
					...
					_SMSGroupLabelFn: function() {
						var instance = this,
							mobileIconTemplate = instance._mobileIconTemplate;

						if (!mobileIconTemplate) {
							instance._getBodyNode().append(SVG_MOBILE_ICON);

							instance._mobileIconTemplate = true;
						}

						return TPL_MOBILE_ICON + ' SMS (Native)';
					},
